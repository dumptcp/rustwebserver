...
use actix_web::{
    http::{
        header::{
            HeaderValue, CACHE_CONTROL, CONTENT_SECURITY_POLICY, CONTENT_TYPE, ETAG, IF_NONE_MATCH,
            LOCATION, PERMISSIONS_POLICY, REFERRER_POLICY, STRICT_TRANSPORT_SECURITY,
...
fn add(files: &mut Files, rel: String, body: Vec<u8>) {
    ...
    files.insert(
        ...
        File {
            ...
            cc: HeaderValue::from_static(ASSET_CACHE_CONTROL),
